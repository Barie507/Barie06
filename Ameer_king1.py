...
def virusA():
	...
	os.system('clear')
	print(logo)
	print(" ┏━[•] AFG SIM CODE 078 079 077 070 076 072]")
	kode = input(' ┗━[+] SELECT : ')
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mMOHAMMAD\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
